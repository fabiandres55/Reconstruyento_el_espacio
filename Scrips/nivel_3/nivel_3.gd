...
var escena_de_figura_a_entrar_3
...
func _ready():
	...
	if get_node("/root/Multi_verificacion").posicion_camara_nivel_3 == null or get_node("/root/Multi_verificacion").posicion_camara_nivel_3 == Vector2(963,539) :
		$Camera2D.position = posicion_1
	elif get_node("/root/Multi_verificacion").posicion_camara_nivel_3 == Vector2(2873,539):
...
func _on_salida_level_animation_finished(anim_name):
	if escena_de_figura_a_entrar_3 == 1:
		get_tree().change_scene("res://Escenas/Teselados/Teselado_N3_F1.tscn")
	elif escena_de_figura_a_entrar_3 == 2:
		get_tree().change_scene("res://Escenas/Teselados/Teselado_N3_f2.tscn")
	else:
		get_tree().change_scene("res://Escenas/Teselados/Teselado_N3_f3.tscn")
	pass # Replace with function body.


func _on_TextureButton_pressed():
	$selec_figura.play(0.06)
	escena_de_figura_a_entrar_3 = 1
